...
function Gemini() {
  ...
  // const handleUploadClick = async (selectedVideo) => {
  //   try {
  //     if (!selectedVideo) {
  ...
  //     const formData = new FormData();
  //     formData.append("video", selectedVideo.src); // Use the video source path
  ...
  //     // Process the response or move to the next step
  //     checkProcessing(resp.data);
  //   } catch (err) {
  //     console.error("Error Uploading Video", err);
  //     setState(UploadState.Failure);
